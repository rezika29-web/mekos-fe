<template>
    <div>
        ...
        <v-btn color="primary" to="/admin/about/add">
            <v-icon>add</v-icon>
            Add New About
        </v-btn>
        <br/><br/>
        <div>
            ...
            <data-table :headers='headers' :items='datas' :search.sync='cari'>
                <template slot="field" slot-scope="props">
                    ...
                    <td>
                        <v-tooltip left>
                            <v-btn fab dark small color ="cray" slot="activator" :to='"/admin/about/"+props.props.item.id+"/edit"'>
