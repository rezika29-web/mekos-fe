<template>
    <div>
        <v-card>
            ...
            <v-form>
                <v-card-text>
                    <v-text-field label="Name" v-model="mutableContent.name"></v-text-field>
                    <v-text-field label="Id Header" v-model="mutableContent.id_header"></v-text-field>
                    <v-textarea name="input-7-1" v-model="mutableContent.desc"
                                label="Description">
                    </v-textarea>
                ...
                <v-card-actions>
                    ...
                    <v-btn color="warning" to="/admin/item">Cancel</v-btn>
                </v-card-actions>
            </v-form>
        </v-card>
    </div>
